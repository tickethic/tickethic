    ...
    <html lang="fr">
      <head>
        ...
        <meta 
          ...
          content="default-src 'self' 'unsafe-inline' 'unsafe-eval' data: blob: https:; connect-src 'self' https: wss: ws: https://rpc.walletconnect.org https://*.walletconnect.org https://*.reown.com https://*.walletconnect.com https://*.storacha.link https://*.w3s.link https://*.nftstorage.link https://*.dweb.link https://ipfs.io https://gateway.originprotocol.com https://dweb.link; img-src 'self' data: https: blob: https://*.storacha.link https://*.w3s.link https://*.nftstorage.link https://*.dweb.link https://ipfs.io https://gateway.originprotocol.com https://dweb.link https://avatars.githubusercontent.com; font-src 'self' data: https: https://fonts.googleapis.com https://fonts.gstatic.com; style-src 'self' 'unsafe-inline' https: https://fonts.googleapis.com https://unpkg.com https://cdnjs.cloudflare.com; style-src-elem 'self' 'unsafe-inline' https: https://fonts.googleapis.com https://unpkg.com https://cdnjs.cloudflare.com; script-src 'self' 'unsafe-inline' 'unsafe-eval' https: https://unpkg.com https://cdnjs.cloudflare.com https://cdn.jsdelivr.net; frame-src 'self' https:; object-src 'none'; base-uri 'self'; form-action 'self'" 
        />
