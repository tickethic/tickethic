      ...
      <div className="w-full flex-1">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {activeTab === 'create' ? (
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              <div className="text-center">
                ...
                <h2 className="text-2xl font-bold text-gray-800 mb-2">Mes événements</h2>
                <p className="text-gray-600 mb-6">
                  Cette fonctionnalité sera bientôt disponible. Vous pourrez gérer tous vos événements créés.
                </p>
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                  ...
                  <ul className="text-left text-blue-700 space-y-2">
                    <li>• Voir les statistiques de vente</li>
                    <li>• Gérer les vérificateurs</li>
                    <li>• Suivre les paiements aux artistes</li>
                    <li>• Modifier les paramètres d'événement</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 text-center">
              <div className="text-3xl font-bold text-blue-600 mb-2">0 ETH</div>
